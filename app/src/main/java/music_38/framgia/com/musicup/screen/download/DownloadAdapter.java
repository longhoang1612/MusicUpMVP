...
public class DownloadAdapter extends RecyclerView.Adapter<DownloadAdapter.DetailViewHolder> {

    private List<Track> mTracks;
    private OnItemPlaylistClickListener mListener;
    private LayoutInflater mLayoutInflater;

    DownloadAdapter(List<Track> tracks, OnItemPlaylistClickListener listener) {
        mTracks = tracks;
        mListener = listener;
    }
